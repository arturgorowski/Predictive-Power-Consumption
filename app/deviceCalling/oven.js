...
const getAllData = require('../DAO/ovenDAO').getAllData;
mongoose.connect('mongodb://localhost/predictivePowerConsumption', { useNewUrlParser: true });
let db = mongoose.connection;
db.on('error', console.error.bind(console, 'connection error'));

let parseResponseHtmlMediaMarkt = require('../mediaMarkt/parsers/oven').parseResponseHtml;
let parseResponseHtmlMediaExpert = require('../mediaExpert/parsers/oven').parseResponseHtml;
let parseResponseHtmlEuroRtvAgd = require('../euroRtvAgd/parsers/oven').parseResponseHtml;
