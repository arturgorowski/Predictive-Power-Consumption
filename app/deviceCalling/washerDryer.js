...
const getAllData = require('../DAO/washerDryerDAO').getAllData;
mongoose.connect('mongodb://localhost/predictivePowerConsumption', { useNewUrlParser: true });
let db = mongoose.connection;
db.on('error', console.error.bind(console, 'connection error'));

let parseResponseHtmlMediaMarkt = require('../mediaMarkt/parsers/washerDryer').parseResponseHtml;
let parseResponseHtmlMediaExpert = require('../mediaExpert/parsers/washerDryer').parseResponseHtml;
let parseResponseHtmlEuroRtvAgd = require('../euroRtvAgd/parsers/washerDryer').parseResponseHtml;
