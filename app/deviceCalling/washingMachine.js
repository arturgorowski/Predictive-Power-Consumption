...
const getAllData = require('../DAO/washingMachineDAO').getAllData;
mongoose.connect('mongodb://localhost/predictivePowerConsumption', { useNewUrlParser: true });
let db = mongoose.connection;
db.on('error', console.error.bind(console, 'connection error'));

let parseResponseHtmlMediaMarkt = require('../mediaMarkt/parsers/washingMachine').parseResponseHtml;
let parseResponseHtmlMediaExpert = require('../mediaExpert/parsers/washingMachine').parseResponseHtml;
let parseResponseHtmlEuroRtvAgd = require('../euroRtvAgd/parsers/washingMachine').parseResponseHtml;
