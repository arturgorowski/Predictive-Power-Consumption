...
const getAllData = require('../DAO/washerDAO').getAllData;
mongoose.connect('mongodb://localhost/predictivePowerConsumption', { useNewUrlParser: true });
let db = mongoose.connection;
db.on('error', console.error.bind(console, 'connection error'));

let parseResponseHtmlMediaMarkt = require('../mediaMarkt/parsers/washer').parseResponseHtml;
let parseResponseHtmlMediaExpert = require('../mediaExpert/parsers/washer').parseResponseHtml;
let parseResponseHtmlEuroRtvAgd = require('../euroRtvAgd/parsers/washer').parseResponseHtml;
